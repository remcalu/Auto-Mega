          ...
          <List dense className="VehicleCard-content-info">
            ...
            <ListItem disablePadding>
              <Stack direction="row" alignItems="center" gap={1}>
                ...
                <ListItemText className="VehicleCard-content-info-text" primary={props.vehicle.mileage === 0 ? "New" : 
                (props.vehicle.mileage === -1 ? "N/A" : formatWithCommas(props.vehicle.mileage) + " km")}/>
              </Stack>
            </ListItem>
            <ListItem disablePadding>
              <Stack direction="row" alignItems="center" gap={1}>
